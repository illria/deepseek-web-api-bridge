...
> V21 Hotfix: restores missing Agent Adapter exports that caused V20 startup ImportError.
...
```bash
cd /root
unzip deepseek-web-api-bridge-v21.zip -d /root
cd /root/deepseek-web-api-bridge-v21
```
